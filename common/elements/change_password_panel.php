<div id='changepasswordbox' class='themeborder glasspanel'>
	<div class='cursorhand leftarrowbutton' onclick='hideGlassPanel("changepasswordbox"); return true;'><img src='img/collapseThumb.png' class='cursorhand' alt='' width='18px' height='18px'/></div>
