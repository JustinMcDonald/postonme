<div id='settingsbox' class='themeborder glasspanel'>
	<div class='cursorhand leftarrowbutton' onclick='hideGlassPanel("settingsbox"); return true;'><img src='img/collapseThumb.png' alt='' width='18px' height='18px'/></div>
